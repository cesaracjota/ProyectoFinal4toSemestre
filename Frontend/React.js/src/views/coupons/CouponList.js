...
const Tables = (props) => {
    ...
    const updateCoupons = (e) => {
      ...
      const fields = ['code', 'start_date', 'expired_date', 'amount','coupon_number', 'used_count', 'status', 'action']
      const data = coupon.map((coupons) =>{
        
        return {
          id: coupons.id,
          code: coupons.code,
          expired_date: coupons.start_date,
          start_date: coupons.expired_date,
...
{/* update */}
                        <Dialog open={openedit} onClose={handleCloseEdit} aria-labelledby="form-dialog-title">
                          ...
                          <DialogContent>
                            <DialogContentText>
                            In this section you can change the characteristics of the coupons created (it is recommended to create a new one)
                            </DialogContentText>
                            ...
                            <TextField
                              ...
                              margin="dense"
                              label="Created Date ..."
                              defaultValue={indice ? (indice.start_date):("")}
                            ...
                            <TextField
                              ...
                              onChange = {(e)=>setIndice({...indice,start_date: e.target.value})}
                              type="date"
                              fullWidth
                            />
                            <TextField
                            ...
                            <TextField
                              ...
                              label="Count"
                              defaultValue={indice ? (indice.coupon_number):("")}
                              onChange = {(e)=>setIndice({...indice,coupon_number: e.target.value})}
                              type="number"
                              fullWidth
                            />
...
{/* inicio pop up */}
                        ...
                        >
                          <DialogTitle id="alert-dialog-title">{"Are you sure you want to update coupon?"}</DialogTitle>
                          <DialogContent>
